...
public class FileBrowser extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		// setup the view
		setContentView(R.layout.text_filebrowser_all);
	...
	protected Dialog onCreateDialog(int id)
	{
		switch (id) {
			...
			case DIALOG_RENAME: {
				...
				textEntryView = factory.inflate(R.layout.text_dialog_rename, null);
			...
			case DIALOG_MKDIR: {
				// create the layout we want
				LayoutInflater factory = LayoutInflater.from(this);
				mkDIRView = factory.inflate(R.layout.text_dialog_mkdir, null);
